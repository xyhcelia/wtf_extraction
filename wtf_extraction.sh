...
perl $path/bin/add_feature.pl -i $path/data/wtf_closest_CDS.txt -c1 1 -p $id.wtfregions.1st.out -c2 1 -c3 2,9,10 -o wtf_closest_CDS.${id}_contig.txt
...
perl $path/bin/wtf_region_reverse.pl $path/data/wtf_gene.tandem_link.newname.bed  ${id}_wtf_region.fa  $id ${id}_wtf_region.reverse.txt
